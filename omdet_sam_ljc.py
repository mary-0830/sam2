...
API_URL = os.getenv("OMDET_API_URL")  # 从环境变量中读取 API_URL
SAVE_DIR = f"/data3/ljj/proj/sam2/test_output/omdet_results/{IMAGE_DIR.split('/')[-2]}"
...
for image_name in IMAGE_NAMES:
    ...
    # 发送请求
    payload = {
        "model_id": "OmDetV2T_base_CXT_B_n104",
        "data": [image_base64],
        "src_type": "base64",
        "tasks": ["橙色的植物"], 
        "labels": ["橙色的植物"], 
